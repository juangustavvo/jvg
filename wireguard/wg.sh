...
# ==================================================
# Link Hosting Kalian
oasistore="raw.githubusercontent.com/juangustavvo/jvg/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${oasistore}/addwg.sh"
wget -O delwg "https://${oasistore}/delwg.sh"
wget -O renewwg "https://${oasistore}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
