...
echo "Checking VPS"
# Link Hosting Kalian
oasistore="raw.githubusercontent.com/senowahyu62/scriptvps/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${oasistore}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${oasistore}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${oasistore}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${oasistore}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${oasistore}/renewssr.sh && chmod +x /usr/bin/renewssr
