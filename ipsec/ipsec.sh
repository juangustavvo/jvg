...
# ==================================================
# Link Hosting Kalian
oasistore="raw.githubusercontent.com/juangustavvo/jvg/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${oasistore}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${oasistore}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${oasistore}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${oasistore}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${oasistore}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${oasistore}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
