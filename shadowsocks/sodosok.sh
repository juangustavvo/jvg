...
echo "Checking VPS"
# Link Hosting Kalian
oasistore="raw.githubusercontent.com/juangustavvo/jvg/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${oasistore}/addss.sh"
wget -O delss "https://${oasistore}/delss.sh"
wget -O cekss "https://${oasistore}/cekss.sh"
wget -O renewss "https://${oasistore}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
