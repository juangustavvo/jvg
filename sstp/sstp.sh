...
echo "Checking VPS"
# Link Hosting Kalian
oasistore="raw.githubusercontent.com/juangustavvo/jvg/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${oasistore}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${oasistore}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${oasistore}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${oasistore}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${oasistore}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
